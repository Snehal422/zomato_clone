    ...
    return(
        <div className="tab-options">
            <div className="max-width options-wrapper">
                {tabs.map((tab) => {
                    return(
                       <div onClick={() => setActiveTab(tab.name)} className={`tab-item absolute-center cur-por ${activeTab === tab.name && 'active-tab'}`}>
                        ...
                        <div className={`tab-name ${activeTab === tab.name && 'active-tab'}`}>{tab.name}</div>
